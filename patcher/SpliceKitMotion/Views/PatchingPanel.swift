...
struct PatchingPanel: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text(model.isUpdateMode ? "Updating SpliceKit Motion" : "Setting Up")
                .font(.title.bold())

            Text(model.isUpdateMode ? "Updating MotionKit framework." : "SpliceKit Motion is enhancing Apple Motion. This may take a minute.")
